...
function createDesignSystemDraft(job: DesignJob): FrameNode {
  const issueKey = textOrFallback(job.issueKey, "No issue key");
...
function createDesignSystemHeader(title: string, issueKey: string, targetUser: string, objective: string): FrameNode {
...
function createColorSystemSection(): FrameNode {
  const swatches = [
...
function createRadiusShadowSection(): FrameNode {
...
function createComponentFoundationSection(): FrameNode {
...
function createStateRulesSection(): FrameNode {
...
function createNamingConventionSection(): FrameNode {
...
function createAiUsageRulesSection(): FrameNode {
  const bullets = [
...
function createSectionCard(title: string, children: SceneNode[]): FrameNode {
...
function createTextSectionCard(title: string, body?: string): FrameNode {
...
function createModeBadge(label: string): FrameNode {
...
function createSwatch(name: string, hex: string): FrameNode {
...
function createTypographyRow(name: string, size: number, weight: string): FrameNode {
...
function createSpacingRow(value: number): FrameNode {
...
function createCodePill(text: string): FrameNode {
...
function createRadiusExample(name: string, radius: number): FrameNode {
...
function createShadowExample(name: string, variant: string): FrameNode {
...
function createComponentPlaceholder(name: string): FrameNode {
...
function createStateCard(name: string): FrameNode {
...
function createBulletRow(text: string): FrameNode {
...
function createVisualTile(name: string, width: number, height: number): FrameNode {
...
function createHorizontalGroup(children: SceneNode[], spacing: number): FrameNode {
...
function createRow(name: string, spacing: number): FrameNode {
...
function collectJobContent(job: DesignJob, keywords: string[]): string {
  const fields = [
...
function stateColor(name: string): RGB {
